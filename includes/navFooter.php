...
<!--<nav class="container-fluid bg-primary p-2 bottom-0 position-fixed">
    <div class="row">
        <div class="col flex-center-column justify-content-around gap-2">
            ...
            <a href="index.php" class="text-white fw-semibold">HJEM</a>
        </div>
        ...
        <div class="col flex-center-column justify-content-around gap-2">
            ...
            <a href="places.php" class="text-white fw-semibold">SØG</a>
        </div>

        <div class="col flex-center-column justify-content-around gap-2">
            <a href="registerPlaces.php">
                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
                    <path d="M32.5 13.75H21.25V2.5C21.25 1.11953 20.1305 0 18.75 0H16.25C14.8695 0 13.75 1.11953 13.75 2.5V13.75H2.5C1.11953 13.75 0 14.8695 0 16.25V18.75C0 20.1305 1.11953 21.25 2.5 21.25H13.75V32.5C13.75 33.8805 14.8695 35 16.25 35H18.75C20.1305 35 21.25 33.8805 21.25 32.5V21.25H32.5C33.8805 21.25 35 20.1305 35 18.75V16.25C35 14.8695 33.8805 13.75 32.5 13.75Z" fill="white"/>
                </svg>
            </a>
            <a href="registerPlaces.php" class="text-white fw-semibold">TILFØJ</a>
        </div>
        ...
        <div class="col flex-center-column justify-content-around gap-2">
            ...
            <a href="likes.php" class="text-white fw-semibold">LIKE</a>
        </div>
    </div>
</nav>